...
public class MemberController {
	 ...
	 * @param userId ~ hobby : 사용자가 입력했던 정보들이 담겨있는 매게변수(원래는 주석을 하나하나 다 써주어야함)
	 */
	...
	public void insertMember(String userId, String userPwd, String userName, String gender, 
		...
		//방법1) 기본생성자로 생성한 후에 각 필등 setter 메소드를 통해서 일일히 담는 방법
		...
		//System.out.println(m); //toString 호출
	...
	public void updateMember(String userId, String userPwd,
		...
		if (result > 0) {
			new MemberMenu().displaySuccess("회원 정보 변경 완료"); 
		} else {
